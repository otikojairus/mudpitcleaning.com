        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr_0.9fr]">
          <div>
            ...
            <p className="mt-3 max-w-md text-white/72">
              Canada-wide service pages for pit cleaning, hydrovac, vacuum truck, catch basin, sewer, septic, tank, and
          ...
          <div>
            ...
            <div className="mt-4 grid gap-2">
              {WATERMAIN_SERVICES.slice(0, 6).map((service) => (
                <Link key={service.name} href={`/${service.hubSlug}`} className="wmc-footer-link">
                  {service.name}
                </Link>
              ))}
            </div>
